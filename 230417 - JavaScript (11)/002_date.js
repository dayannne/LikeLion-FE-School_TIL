...
// new Date(2023, 6, 30)
new Date(2023, 6, 30); // 6월을 표시하기 위해서는 -1을 해야 합니다. 월은 0부터 시작합니다.
//
...
today1 = new Date(); // today의 지정 로캘은 KST다.
...
today1.getTimezoneOffset() / 60;
today1.toString(); // -> Fri Jul 24 2020 12:30:00 GMT+0900 (대한민국 표준시)
today1.toTimeString(); // -> 12:30:00 GMT+0900 (대한민국 표준시)

today2 = new Date('2023/1/20/10:00:00');
today2.toString();
// https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Global_Objects/Date/toISOString
// 국제표준시 기준 형식으로 표현 // "2011-10-05T14:48:00.000Z"
today2.toISOString();
today2.toISOString().slice(0, 10);
today2.toISOString().slice(0, 10).replace(/-/g, '');
...
today2.toLocaleString('ko-KR'); // -> 2020. 7. 24. 오후 12:30:00
today2.toLocaleString('en-US'); // -> 7/24/2020, 12:30:00 PM
today2.toLocaleString('ja-JP'); // -> 2020/7/24 12:30:00
